...
defmodule Tunedrop.TimeHelpers do
  ...
  @doc """
  Generates approximate distance of time between two times.
  """
  def distance_of_time_in_words(from_time, to_time \\ DateTime.now) do
    ...
    words = case distance_in_minutes do
      ...
      n when n in 45..90 ->
        "about 1 hour"
      n when n in 90..1440 ->
        "about #{round(distance_in_minutes / 60.0)} hours"
      n when n in 1440..2520 ->
        "about 1 day"
      n when n in 2520..43200 ->
        "about #{round(distance_in_minutes / 1440.0)} days"
      n when n in 43200..86400 ->
        "about #{round(distance_in_minutes / 43200.0)} months"
      n when n in 86400..525600 ->
        "#{round(distance_in_minutes / 43200.0)} months"
      _ -> "a long time"
    end
    words
  end
